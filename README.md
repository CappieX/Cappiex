...
<div align="center">
  <h3>🧠 MR.CREAMS — AI-Powered Emotional Intelligence Platform</h3>
  <a href="https://github.com/CappieX/MRCREAMS">
    <img src="assets/github_preview.webp" width="95%" />
  </a>
</div>
...
**Live Capabilities**
- Real-time emotion detection (Joy, Anger, Sadness, Fear, Calm)
- AI-powered behavioral & sentiment analysis
- Therapist & organization dashboards
- Secure session recording & analytics
- Multi-role system (Superadmin, Therapists, Clients, Support)

**System Architecture**
- Frontend: React / modern dashboard UI
- Backend: Node.js & Python microservices
- Database: PostgreSQL (real-time capable)
- AI: Custom emotion detection + NLP models
- Real-time: WebSockets
- Security: RBAC, encrypted sessions, GDPR-ready

**Current Scale**
- 56+ therapy professionals  
